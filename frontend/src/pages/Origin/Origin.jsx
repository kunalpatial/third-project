    ...
    <>
      <div className="hero">
        <video autoPlay muted loop playsInline className="bg-video">
          <source src="/assets/CORSAIR_Header_2024_WQHD_2.webm" type="" />
        </video>
      ...
      <div id='laptoplist' class="container-fluid text-center">
        <div class="row align-items-center">
          <div id='laptop' class="col">
            <img src="./assets/computer2.jpeg" alt="" />
            <h5>Gamming desktops</h5>
          </div>
         
          <div id='laptop' class="col">
            <img src="./assets/super-computer1.avif" alt="" />
      ...
      <div id="section4" class="container-fluid">
        <div class="row">
          <div id="text4" class="col">
            <img src="/assets/emblem.webp" alt="" />
      ...
      <div id="lastsection" class="container-fluid text-center">
        <div class="row align-items-start">
          ...
          <div class="col">
            <img src="/assets/maxpc-kickass.webp" alt="" />
          </div>
          <div class="col">
            <img src="/assets/pcmag-editors-choice.webp" alt="" />
          </div>
          <div class="col">
            <img src="/assets/toms-guide-gaming-desktops.webp" alt="" />
          </div>
          <div class="col">
            <img src="/assets/techradar-editors-choice.webp" alt="" />
          </div>
        </div>
        <div class="row align-items-start mt-3 ">
          <div class="col">
            <img src="/assets/toms-hardware-readers-choice.webp" alt="" />
          </div>
          <div class="col">
            <img src="/assets/tweaktown-editors-choice.webp" alt="" />
          </div>
          <div class="col">
            <img src="/assets/tweaktown-best-performance.webp" alt="" />
          </div>
          <div class="col">
            <img src="/assets/pc-perspective-editors-choice.webp" alt="" />
          </div>
          <div class="col">
            <img src="/assets/ces-innovations.webp" alt="" />
          </div>
        </div>
      </div>
